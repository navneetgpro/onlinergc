...
<section class="white section">
    <div class="container">
                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <img src="<?=base_url('assets/f/upload/about_01.jpg')?>" alt="" class="img-responsive">
                            </div>
                            <div class="item">
                                <img src="<?=base_url('assets/f/upload/about_02.jpg')?>" alt="" class="img-responsive">
                            </div>
                        </div>
                ...
                <div class="content-widget">
                    ...
                    <div class="team-members row">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="team">
                                <img src="<?=base_url('assets/f/upload/team_01.jpg')?>" alt="" class="img-responsive wow fadeInUp">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="team">
                                <img src="<?=base_url('assets/f/upload/team_02.jpg')?>" alt="" class="img-responsive wow fadeInUp">
                                <div class="team-hover-content">
                                    <h5>Adam DEO</h5>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="team">
                                <img src="<?=base_url('assets/f/upload/team_03.jpg')?>" alt="" class="img-responsive wow fadeInUp">
                                <div class="team-hover-content">
                                    <h5>Jenny Kennedy</h5>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="team">
                                <img src="<?=base_url('assets/f/upload/team_04.jpg')?>" alt="" class="img-responsive wow fadeInUp">
                                <div class="team-hover-content">
                                    <h5>Jennifer DEO</h5>
        ...
        <div class="row">
            <div class="col-md-2">
                <img src="<?=base_url('assets/f/upload/client_01.png')?>" alt="" class="img-responsive img-thumbnail">
            </div>

            <div class="col-md-2">
                <img src="<?=base_url('assets/f/upload/client_02.png')?>" alt="" class="img-responsive img-thumbnail">
            </div>

            <div class="col-md-2">
                <img src="<?=base_url('assets/f/upload/client_03.png')?>" alt="" class="img-responsive img-thumbnail">
            </div>

            <div class="col-md-2">
                <img src="<?=base_url('assets/f/upload/client_04.png')?>" alt="" class="img-responsive img-thumbnail">
            </div>
            
            <div class="col-md-2">
                <img src="<?=base_url('assets/f/upload/client_05.png')?>" alt="" class="img-responsive img-thumbnail">
            </div>

            <div class="col-md-2">
                <img src="<?=base_url('assets/f/upload/client_06.png')?>" alt="" class="img-responsive img-thumbnail">
            </div>
